...
@RestController
@RequestMapping("/api/user-registration-kafka")
public class UserRegistrationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(UserRegistrationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public UserRegistrationKafkaResource(KafkaProperties kafkaProperties) {
